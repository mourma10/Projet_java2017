...
*/
public void ajouterMembre(Membre pers) throws SQLException{
    ...
    void supprimerData(Membre pers) throws Exception
    {
        String requete = "delete from membre where login = \""+pers.getLogin()+"\"";
        int a = st.executeUpdate(requete);
